 ...
 * The source Renderscript file: C:\\Users\\Alistair\\git\\Master's Project\\CVDVision2\\src\\com\\dundeeuni\\Alistair\\cvdvision\\lut.rs
 */
 ...
 * @hide
 */
public class ScriptC_lut extends ScriptC {
    private static final String __rs_resource_name = "lut";
    // Constructor
    public  ScriptC_lut(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_lut(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportVarIdx_lut = 0;
    private Allocation mExportVar_lut;
    public synchronized void set_lut(Allocation v) {
        setVar(mExportVarIdx_lut, v);
        mExportVar_lut = v;
    }
